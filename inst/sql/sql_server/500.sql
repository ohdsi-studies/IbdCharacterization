...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4291025,36516779)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4291025,36516779)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (79903,36516815)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (79903,36516815)
  and c.invalid_reason is null
