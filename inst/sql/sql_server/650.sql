...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (37393847)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (37393847)
...
JOIN @cdm_database_schema.PERSON P on C.person_id = P.person_id
WHERE C.value_as_number < 11.5000
AND YEAR(C.observation_date) - P.year_of_birth < 12
-- End Observation Criteria
...
JOIN @cdm_database_schema.PERSON P on C.person_id = P.person_id
WHERE C.value_as_number < 115.0000
AND C.unit_concept_id in (8636)
AND YEAR(C.observation_date) - P.year_of_birth < 12
-- End Observation Criteria
