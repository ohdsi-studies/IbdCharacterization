...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (37393863)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (37393863)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (35104691)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (35104691)
  and c.invalid_reason is null
...
WHERE C.value_as_number < 150000.0000
AND C.unit_concept_id in (8647,9436,8961)
-- End Observation Criteria
