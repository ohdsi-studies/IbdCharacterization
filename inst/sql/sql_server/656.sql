...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4208414,37051295,37398482,37398420,37025552)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4208414,37051295,37398482,37398420,37025552)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (36365199,36315484)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (36365199,36315484)
  and c.invalid_reason is null
...
AND C.unit_concept_id in (4122414,8751)
-- End Observation Criteria
