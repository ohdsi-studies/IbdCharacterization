...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (36903606)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (36903606)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (762505,4295031,4212469,44788913)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (762505,4295031,4212469,44788913)
  and c.invalid_reason is null
